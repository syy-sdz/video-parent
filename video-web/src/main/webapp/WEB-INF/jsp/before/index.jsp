...
<header>
    <div class="container">
        ...
        <a class="color_e4"><img src="${pageContext.request.contextPath}/img/phone.png" draggable="false"> 0371-666-9092&#x3000;&#x3000;0371-666-9051</a>
    ...
    <ul>
        ...
        <li class="mt25">
            ...
            <ul id="foo_icon">
                ...
                <li>电话:0395-208-9051 0371-666-9092</li>
                <li class="erwei">
                    <br>
                    <div>
...
ss:${pageContext.request.contextPath}<br>
